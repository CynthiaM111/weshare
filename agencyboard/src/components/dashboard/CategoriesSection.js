                                ...
                                <div key={category._id} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        <button
                                            ...
                                            className="px-3 py-2 bg-red-100 text-red-700 rounded-lg text-sm font-medium hover:bg-red-200 transition-colors duration-200 flex items-center gap-1"
                                        >
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="bg-white rounded-lg max-w-md w-full p-6 shadow-xl">
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                            <p className="text-sm font-medium text-gray-900 mb-1">
                                {categoryToDelete.from} → {categoryToDelete.to}
                            </p>
                            <p className="text-sm text-gray-600">
                                {categoryToDelete.rideCount} rides • {categoryToDelete.bookingCount} bookings • ${categoryToDelete.totalRevenue?.toLocaleString() || 0} revenue
                            </p>
                        </div>
